...
class _KnowledgeGapsChartState extends State<KnowledgeGapsChart> {
  late Future<Result<List<KnowledgeGap>>> _gapsFuture;
  ...
  void _loadData() {
    ...
    _gapsFuture = gapRepo.getUnresolvedGaps(widget.userId);
                  ...
                  return gapsResult.fold(
                    (gaps) => topicsResult.fold(
                      (topics) {
                        ...
                        final maxY = (displayEntries.first.value * 1.2).ceil().toDouble();
